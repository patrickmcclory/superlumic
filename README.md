...
Start by forking [superlumic-config](https://github.com/patrickmcclory/superlumic-config). This is the default configuration "role" for Superlumic and will serve as a starting point for your own configuration.
...
```
curl -s https://raw.githubusercontent.com/patrickmcclory/superlumic/master/superlumic | bash -s <your repo clone url here>
```
